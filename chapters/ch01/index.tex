...
Penelitian ini memiliki tujuan, yaitu:
	\begin{enumerate}
		\item
		Untuk mengukur kinerja Hadoop dan Spark ketika diuji menggunakan  beban kerja \textit{Micro Benchmarks} yang disediakan oleh HiBench
		\item
		Untuk mengukur kinerja Hadoop dan Spark ketika diuji menggunakan  beban kerja SQL yang disediakan oleh HiBench
		\item 
