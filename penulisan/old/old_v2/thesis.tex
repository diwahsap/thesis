...
\begin{document}
    ...
    \justifying
    \input{chapters/ch01/index.tex}
    \input{chapters/ch02/index.tex}
    \input{chapters/ch03/index.tex}
    \input{chapters/ch04/index.tex}
    \input{chapters/ch05/index.tex}
    %----------------------------------------------------------------%
